...
## Guiding Principles
- **Standards-first seams:** Runtime command remains BYO, driven by CLI I/O (`trial_input.json` / `result.json`) plus optional evidence (hooks JSONL, OTel).
...
- `.lab/runs/<run_id>/trials/<trial_id>/result.json`
